             ...
             <div className="grid md:grid-cols-2 gap-10">
                <div className="space-y-8">
                   ...
                   <button 
                     ...
                     className="group h-20 w-full border border-white/10 hover:border-[#FF4D00] flex items-center justify-between px-8 transition-all overflow-hidden relative bg-black/40 backdrop-blur-xl pointer-events-auto"
                   >
