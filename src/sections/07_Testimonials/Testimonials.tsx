...
const StatCounter = ({ end, suffix }: { end: number, suffix: string }) => {
  ...
  return (
    <span ref={ref} className="font-[var(--font-display)] text-[clamp(80px,12vw,140px)] text-[var(--color-gold)] leading-none">
      {value}{suffix}
    </span>
  );
};
  ...
  return (
    <SectionWrapper id="testimonials">
      ...
      <div className="flex flex-col items-center text-center gap-10 mb-32 relative">
        ...
        <div className="w-[2px] h-20 bg-[var(--color-gold)] relative z-10" />
        ...
        <motion.h2
          ...
          className="font-[var(--font-display)] text-7xl md:text-8xl text-[var(--color-gold)] m-0 relative z-10"
        >
          Until now.
        </motion.h2>
      </div>
      ...
      <div className="flex flex-wrap justify-around gap-12 items-center">
        <div className="flex flex-col items-center gap-2">
           ...
           <span className="font-mono text-[10px] text-[var(--color-gold)] uppercase tracking-widest">Authentic Dishes</span>
        </div>
        <div className="flex flex-col items-center gap-2">
           <StatCounter end={3} suffix="" />
           <span className="font-mono text-[10px] text-[var(--color-gold)] uppercase tracking-widest">Cities Served</span>
        </div>
        <div className="flex flex-col items-center gap-2">
           <StatCounter end={100} suffix="%" />
           <span className="font-mono text-[10px] text-[var(--color-gold)] uppercase tracking-widest">Handcrafted</span>
        </div>
      </div>
    </SectionWrapper>
  );
