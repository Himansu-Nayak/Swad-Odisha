          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">123 Heritage Street, Old Town</p>
                  <p className="text-gray-300">Bhubaneswar, Odisha 751001</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">hello@swadodisha.com</p>
              </div>
            </div>
